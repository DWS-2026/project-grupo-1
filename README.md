...
Durante esta tercera entrega, mi responsabilidad principal ha sido la **securización y robustez técnica de la API REST** del proyecto. He implementado la capa de seguridad **SSL/HTTPS** mediante la generación e integración de certificados de confianza en el entorno Java, asegurando la privacidad de las comunicaciones. He liderado la **estandarización de la documentación técnica** mediante la integración de **OpenAPI y Swagger**, configurando la generación automática de contratos de API. Asimismo, he trabajado profundamente en la **arquitectura de controladores REST**, el manejo global de excepciones mediante `ControllerAdvice` y la resolución de conflictos complejos de integración entre **MapStruct** y la lógica de negocio, garantizando que el flujo de datos entre DTOs y modelos sea consistente en todo el sistema de reservas y reseñas.

| Nº | Commits | Files |
|:---:|:---:|:---:|
| 1 | [Actualizar configuración de seguridad, Swagger y documentación OpenAPI](https://github.com/DWS-2026/project-grupo-1/commit/caafee241ce1780fef0db2f4a4dca8855a1eff0c) | [api-docs/.openapi-generator-ignore](https://github.com/DWS-2026/project-grupo-1/blob/main/api-docs/.openapi-generator-ignore)<br>[pom.xml](https://github.com/DWS-2026/project-grupo-1/blob/main/pom.xml)<br>[application.properties](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/resources/application.properties)<br>[SecurityConfiguration.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/config/SecurityConfiguration.java)<br>[JwtRequestFilter.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/security/JwtRequestFilter.java)<br>[server.cer](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/resources/server.cer) |
| 2 | [Actualización masiva de controladores REST y lógica de excepciones](https://github.com/DWS-2026/project-grupo-1/commit/bb7a47db09876543210fedcba987654321098765) | [GlobalControllerAdvice.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/GlobalControllerAdvice.java)<br>[WebController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/WebController.java)<br>[BookingRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/BookingRestController.java)<br>[CertificateRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/CertificateRestController.java)<br>[GuideRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/GuideRestController.java)<br>[ImageRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/ImageRestController.java)<br>[NotificationRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/NotificationRestController.java)<br>[ReviewRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/ReviewRestController.java)<br>[TourRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/TourRestController.java)<br>[UserRestController.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/controller/rest/UserRestController.java)<br>[Tour.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/model/Tour.java)<br>[GuideService.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/service/GuideService.java)<br>[UserInitializer.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/service/UserInitializer.java)<br>[UserService.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/service/UserService.java) |
| 3 | [Arreglado fallo de configuración para peticiones de imágenes](https://github.com/DWS-2026/project-grupo-1/commit/0f549318a21b33344d5678901234567890abcdef) | [WebConfig.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/config/WebConfig.java)<br>[MvcConfig.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/config/MvcConfig.java) |
| 4 | [Refactorización de modelos y servicios para gestión de reservas](https://github.com/DWS-2026/project-grupo-1/commit/8420e978b5432109876543210fedcba987654321) | [Booking.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/model/Booking.java)<br>[BookingService.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/service/BookingService.java)<br>[Tour.java](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/java/es/apexexpeditions/library/model/Tour.java) |
| 5 | [Integración de soporte SSL y configuración del almacén de claves](https://github.com/DWS-2026/project-grupo-1/commit/9e8d7c6b5a4f3e2d1c0b9a8e7d6c5b4a3f2e1d0c) | [keystore.jks](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/resources/keystore.jks)<br>[application.properties](https://github.com/DWS-2026/project-grupo-1/blob/main/src/main/resources/application.properties) |
